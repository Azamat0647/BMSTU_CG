...
int SetOfPoints::lenght() { return points.size(); }
...
QRectF SetOfPoints::boundingRect() { return _boundingRect; }

QPointF &SetOfPoints::operator[](unsigned index) { return points[index]; }
